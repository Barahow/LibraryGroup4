...
public class MailSender {
    ...
    private static final String USER_NAME = "library.system2000";  // GMail user name (just the part before "@gmail.com")
    private static final String PASSWORD = "Librarysys"; // GMail password
