...
*/
        ...
        Parent bView = loader.load(getClass().getResource("/view/BookList.fxml"));
  ...
  public void homePage2(ActionEvent event) throws IOException {
      Stage window = (Stage) backhome.getScene().getWindow();
      window.close();

     /* Parent list = FXMLLoader.load(getClass().getResource("../view/StartMenu.fxml"));
