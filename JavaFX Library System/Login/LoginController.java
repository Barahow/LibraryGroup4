...
public class LoginController extends AbstractController implements Initializable {
    ...
    @FXML private Button signina;

    @FXML private Label forgotpassa;
    @FXML private TextField mytext;

    @FXML private Label close;
    @FXML private Label label;
    @FXML private ScrollPane anchorpin;
    static String name;
    ...
    public void signIn(ActionEvent event) {
        ...
        try {
            if (dbConnection.signIn(um, pm)) {
                ...
                Parent bView = loader.load(getClass().getResource("/Login/userInfo.fxml"));
...
//    }
    ...
    public void signUp(ActionEvent event){
        ...
        try{
        changeScene(event, "../Login/signUpView.fxml");
    }catch (IOException e){
            e.printStackTrace();
        }
    }
